...
//	}
	...
	echo "<tr><td align='center'><div style='width:180px;' ><br/><strong>$GalleryName</strong><br/>Shortcodes<br/><br/></div></td>";
	echo "<td align='center'><div style='width:180px;' ><br/><strong>Gallery shortcode:</strong><br/>[cg_gallery id=\"$GalleryID\"]<br/><br/></div></td>";
	echo "<td align='center'><div style='width:180px;' ><br/><strong>Upload form shortcode:</strong><br/>[cg_users_upload id=\"$GalleryID\"]<br/><br/></div></td>";
